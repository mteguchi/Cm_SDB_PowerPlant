...
hist(areas.combos$area95)
quantile(areas.combos$area95, c(0.025, 0.05, 0.10, 0.15, 0.50, 0.975))
```
...
ggsave(filename = paste0("figures/HR_pre_h", h.pre, "_", Sys.Date(), ".png"),
       plot = map.pre.HR,
       dpi = 600,
       device = "png")

ggsave(filename = paste0("figures/HR_post_h", h.post, "_", Sys.Date(), ".png"),
       plot = map.post.HR,
       dpi = 600,
       device = "png")
#plot(map.post.HR)
