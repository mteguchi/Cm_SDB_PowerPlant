...
Now that we know the stability of the core use area with respect to the sample sizes, we compute them extracting the land space.  
...
area.pre.50 <- slot(area.pre.daynight.50@polygons[[1]], "area")
