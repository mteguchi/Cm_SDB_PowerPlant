...
# NOT WORKING AS OF 1/6/2020 FIX BELOW!!!!  
...
idx2 <- sapply(tmp2,
               function(x) min(coordinates(x)[,2]) < N.end)
...
# Then, put them together as one.
eelg.2014.latlon.south <- SpatialPolygons(list(Polygons(srl = tmp2[idx2], ID = "0"),
...
post.eelgrass.UD.50 <- rgeos::gIntersection(eelg.2014.UTM.south, area.post.daynight.50)
post.eelgrass.UD.95 <- rgeos::gIntersection(eelg.2014.UTM.south, area.post.daynight.95)
