...
ggsave(filename = "figures/preVsPost_effect_n.png",
       plot = p.dif.dist,
       device = "png",
       dpi = 600)
...
ggsave(filename = "figures/preVsPost_n6.png",
       plot = p.d50.n6,
       device = "png",
       dpi = 600)
...
So, the majority of the differences are above zero (94.5%), indicating that there was an increase in 50% UDs after the PP shut down. 
