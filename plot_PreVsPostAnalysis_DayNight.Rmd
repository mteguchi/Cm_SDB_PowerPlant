...
KD.eachID.pre.combined <- all.data.frames$KD.eachID.pre.combined
...
KD.eachID.post.combined <- all.data.frames$KD.eachID.post.combined
...
KD.eachID.pre.day <- all.data.frames$$KD.eachID.pre.day
...
KD.eachID.pre.night <- all.data.frames$KD.eachID.pre.night
...
KD.eachID.post.day <- all.data.frames$KD.eachID.post.day
...
KD.eachID.post.night <- all.data.frames$KD.eachID.post.night
...
```{r}
UD.pre.95.latlon <- all.data.frames$UD.pre.95.latlon
UD.pre.50.latlon <- all.data.frames$UD.pre.50.latlon
...
```{r}
UD.post.95.latlon <- all.data.frames$UD.post.95.latlon
UD.post.50.latlon <- all.data.frames$UD.post.50.latlon
...
```{r}
UD.pre.day.night.95.latlon <- all.data.frames$UD.pre.day.night.95.latlon
UD.pre.day.night.50.latlon <- all.data.frames$UD.pre.day.night.50.latlon
...
UD.post.day.night.95.latlon <- all.data.frames$UD.post.day.night.95.latlon
UD.post.day.night.50.latlon <- all.data.frames$UD.post.day.night.50.latlon
...
if (save.fig)
  ggsave(plot = p.KDE.pre.post.DayVsNight,
         filename = "figures/KDE_pre_post_all_DayVsNight.png",
         device = "png",
         dpi = 600)
...
Results are saved in .RData file (Out_PreVsPostAnalysis_DayNight.RData)
