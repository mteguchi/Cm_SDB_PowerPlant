...
UD.post.50.latlon <- all.data.framesUD50.allID.post.daynight 
UD.pre.95.latlon <- all.data.framesUD95.allID.pre.daynight 
...
UD.pre.night.50.latlon <- all.data.framesUD50.allID.pre.night 
