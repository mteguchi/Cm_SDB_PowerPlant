...
UD.pre.95 <- get.area.UTM(getverticeshr(UD.pre, 95, 
                                        unin = "m", unout = "km2"))
UD.pre.50 <- get.area.UTM(getverticeshr(UD.pre, 50, 
                                        unin = "m", unout = "km2"))
...
UD.post.95 <- get.area.UTM(getverticeshr(UD.post, 95, 
                                         unin = "m", unout = "km2"))
UD.post.50 <- get.area.UTM(getverticeshr(UD.post, 50, 
                                         unin = "m", unout = "km2"))
...
UD.pre.day.95 <- get.area.UTM(getverticeshr(UD.pre.day, 95, 
                                            unin = "m", unout = "km2"))
UD.pre.day.50 <- get.area.UTM(getverticeshr(UD.pre.day, 50, 
                                            unin = "m", unout = "km2"))
...
UD.pre.night.95 <- get.area.UTM(getverticeshr(UD.pre.night, 95, 
                                              unin = "m", unout = "km2"))
UD.pre.night.50 <- get.area.UTM(getverticeshr(UD.pre.night, 50, 
                                              unin = "m", unout = "km2"))
...
UD.post.day.95 <- get.area.UTM(getverticeshr(UD.post.day, 95, 
                                             unin = "m", unout = "km2"))
UD.post.day.50 <- get.area.UTM(getverticeshr(UD.post.day, 50, 
                                             unin = "m", unout = "km2"))
...
UD.post.night.95 <- get.area.UTM(getverticeshr(UD.post.night, 
                                               95, unin = "m", 
                                               unout = "km2"))
UD.post.night.50 <- get.area.UTM(getverticeshr(UD.post.night, 50, 
                                               unin = "m", 
                                               unout = "km2"))
...
save.list <- list(UD.eachID.pre.daynight = UD.eachID.pre.combined, 
                  ...
                  UD.allID.pre.daynight = UD.pre, 
                  UD.allID.pre.day = UD.pre.day,
                  UD.allID.pre.night = UD.pre.night,
                  ...
                  UD.allID.post.daynight = UD.post, 
                  UD.allID.post.day = UD.post.day,
                  UD.allID.post.night = UD.post.night)

#saveRDS(save.list, file = "RData/PreVsPost_DayNight_Dec2019.RDS")

# Added the complete output of kernelUD to output list of UD.eachID 
# function in Dec 2021, in order to respond to Mike Zickel's request
# for HR data. New outputs were saved in the new rds file.
saveRDS(save.list, file = "RData/PreVsPost_DayNight_Dec2021.rds")
