...
```{r}
summary.argos <- function(dname, N.end = 32.69){
  ...
  if (length(grep("data/files_Jul2018_withNewTags/pre/", dname)) > 0){
    ...
    if (length(grep("data/files_Jul2018_withNewTags/post/", dname)) == 1){
...
pre.dname <- "data/files_Jul2018_withNewTags/pre/"
post.dname <- "data/files_Jul2018_withNewTags/post/"
new.dname <- "data/files_Jul2018_withNewTags/new/"
